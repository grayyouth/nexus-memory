...
**Nexus** — это система общей памяти для любых AI-агентов (Cline, Gea, локальные LLM
...
Если решение принято несколькими агентами (например, Cline + Gea):
...
Агент `cline` не увидит личные заметки агента `Gea`, но оба увидят общие
